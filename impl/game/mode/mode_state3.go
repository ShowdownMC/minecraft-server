...
import (
	...
	impl_level "github.com/ShowdownMC/minecraft-server/impl/game/level"

	impl_event "github.com/ShowdownMC/minecraft-server/impl/game/event"

	client_packet "github.com/ShowdownMC/minecraft-server/impl/prot/client"
	server_packet "github.com/ShowdownMC/minecraft-server/impl/prot/server"
)
